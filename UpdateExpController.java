...
public class UpdateExpController  {
    ...
    void loadimg(MouseEvent event) throws IOException {
        ...
        destinationFile = new File("C:/Users/Th3_D0cTor/OneDrive/Documents/NetBeansProjects/backup/bach/bachafx/src"+newPath+"/"+nameimg+"."+extension);
    ...
    void Post(MouseEvent event) {
        try{
        query = "UPDATE evenement set nom_evenement=?,description=?  , img=? , capacite=? WHERE id="+id;
        ...
        preparedStatement.setString(4,nbp.getText());
    ...
    public void setDatas(int id,String tit,String descr,String img,int cap){
        title.setText(tit);
        description.setText(descr);
        path.setText(img);
        nbp.setText(String.valueOf(cap));
